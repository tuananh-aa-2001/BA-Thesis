...
Die Abbildung 4.1 zeigt das System, welche sowohl die Schnittstelle zum Benutzer darstellt also auch mit anderen externen System zum Importieren der Daten. Daraus hinaus ist es mit einem Datenbankmanagementsystem zur Speicherung von Daten verbunden.
\begin{figure}[H]
	\centering
	\includegraphics[width=9cm]{Kontextangrenzung.png}
	\caption{\label{} Kontextangrenzung}
\end{figure}
\section*{\large \textbf{Bausteinschicht}}
Die Bausteinschicht zeigt den inneren Aufbau des Systems - und zwar denjenigen Teil, den entwickelt wird.
